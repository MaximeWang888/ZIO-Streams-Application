...
Nous avons décidé de travailler sur la météo pour quelques raisons claires. Tout d'abord, l'API météo que nous utilisons est gratuite et permet de faire plusieurs demandes sans frais supplémentaires, rendant le développement plus facile. En choisissant un sujet aussi familier que la météo, nous pensons que le projet est plus accessible à tout le monde. Cela nous a également permis de nous concentrer sur l'apprentissage de Scala et ZIO, des outils que nous ne connaissions pas au départ, sans être dépassés par des détails complexes. En bref, la météo nous offre une opportunité pratique de comprendre ces nouveaux concepts tout en simplifiant le développement grâce à une API gratuite et conviviale.
